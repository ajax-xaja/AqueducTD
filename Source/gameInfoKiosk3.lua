...
--[[	
	...
	local function levelSetup()
		...
		local function kioskTowers( )
			local tower = Towers.PistolTower:new(144, 144, enemyGroup)
			table.insert(towerArray, 44, tower)
			local tower = Towers.ShotgunTower:new(272, 208, enemyGroup)
			table.insert(towerArray, 68, tower)
			local tower = Towers.MagnumTower:new(208, 272, enemyGroup)
			table.insert(towerArray, 86, tower)
			local tower = Towers.RocketTower:new(272, 144, enemyGroup)
